...
const setupRoutes = (routes) => {
  ...
  routes.forEach((route) => {
    if (route.method === 'GET') router.route(route.path).get(route.bind);
    if (route.method === 'POST') router.route(route.path).post(route.bind);
    if (route.method === 'PUT') router.route(route.path).put(route.bind);
    if (route.method === 'DELETE') router.route(route.path).delete(route.bind);
  });
};
...
const userRoutes = new Array(
  ...
  { path: '/users/changes', method: 'GET', bind: userFunctions.getChanges },
  { path: '/users/changes', method: 'POST', bind: userFunctions.setChanges },
  {
    path: '/users/changes',
    method: 'DELETE',
    bind: userFunctions.deleteChanges
  }
);
...
const authRoutes = new Array(
  ...
  { path: '/users/logout', method: 'POST', bind: authFunctions.logout },
  {
    ...
    method: 'GET',
    bind: authFunctions.loginWithProvider
  },
...
const currenciesRoutes = new Array(
  {
    path: '/currencies/refresh',
    method: 'GET',
    bind: currenciesFunctions.setAll
  },
  {
    path: '/currencies',
    method: 'GET',
    bind: currenciesFunctions.getAllCrypto
  },
  {
    path: '/currencies/:CurId',
    method: 'GET',
    bind: currenciesFunctions.getOneCrypto
  },
  {
    path: '/currencies/:CurId',
    method: 'DELETE',
    bind: currenciesFunctions.deleteOneCryptoDocument
  },
  {
    path: '/currencies',
    method: 'POST',
    bind: currenciesFunctions.createOneCryptoDocument
  }
);
...
const cryptoBankRoutes = new Array(
  {
    path: '/users/:UserId/currencies',
    method: 'GET',
    bind: cryptosBankFunctions.getAllhisCryptos
  },
  {
    path: '/users/:UserId/currencies/:CurrId',
    method: 'GET',
    bind: cryptosBankFunctions.getOneCryptos
  },
  {
    path: '/users/:UserId/currencies/:CurrId',
    method: 'PUT',
    bind: cryptosBankFunctions.setOneCrypto
  },
  {
    path: '/users/:UserId/currencies/:CurrId',
    method: 'DELETE',
    bind: cryptosBankFunctions.deleteOneCrypto
  }
);
